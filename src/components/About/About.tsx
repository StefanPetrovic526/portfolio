    ...
    <div className='about' id='about'>
      <div className='about__left'>
        ...
        <div className='about__description'>
          Hello! My name is
          {' '}
          <span className='about__link'>Stefan&nbsp;Petrovic</span>
          {' '}
          ...
          {' '}
          <a href='' target='_blank' rel='noreferrer' className='intro__link'>Megatrend University</a>
          {' '}
          ...
          <ul className='about__skillsList'>
            ...
            <li className='about__skillsItems'>Three.js</li>
